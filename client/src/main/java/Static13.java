...
public final class Static13 {
    ...
    private static DelayedStateChange[] aDelayedStateChangeArray1;
    ...
    public static void method302(@OriginalArg(0) int arg0) {
        aDelayedStateChangeArray1 = new DelayedStateChange[arg0 + 1];
    ...
    public static void method304(@OriginalArg(0) int arg0) {
        try {
            ...
            aDelayedStateChangeArray1 = null;
    ...
    public static DelayedStateChange method305(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
        try {
            if (!arg0) {
                anInt541 = -277;
            }
            return aDelayedStateChangeArray1 == null ? null : aDelayedStateChangeArray1[arg1];
        } catch (@Pc(12) RuntimeException local12) {
