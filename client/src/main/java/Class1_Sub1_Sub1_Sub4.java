...
public final class Class1_Sub1_Sub1_Sub4 extends Class1_Sub1_Sub1 {
    ...
    private SoundPcmStream aSoundPcmStream1;
    ...
    public Class1_Sub1_Sub1_Sub4(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11) {
        try {
            ...
            this.aSoundPcmStream1 = Static26.aSoundPcmStreamArray1[arg3];
            this.width = arg10;
            this.anInt890 = arg8;
            this.anInt466 = arg2;
            this.anInt891 = arg1;
    ...
    public void method242(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
        try {
            ...
            if (this.aSoundPcmStream1.aClass27_2 != null) {
                this.anInt477 += arg0;
                while (this.anInt477 > this.aSoundPcmStream1.aClass27_2.method506(-574, this.anInt476)) {
                    this.anInt477 -= this.aSoundPcmStream1.aClass27_2.method506(-574, this.anInt476) + 1;
                    this.anInt476++;
                    if (this.anInt476 >= this.aSoundPcmStream1.aClass27_2.anInt794) {
                        this.anInt476 = 0;
                    }
                }
            }
    ...
    protected Sound method676(@OriginalArg(0) int arg0) {
        try {
            ...
            @Pc(12) Sound local12 = this.aSoundPcmStream1.method523();
            if (local12 == null) {
                return null;
            }
            @Pc(18) int local18 = -1;
            if (this.aSoundPcmStream1.aClass27_2 != null) {
                local18 = this.aSoundPcmStream1.aClass27_2.anIntArray225[this.anInt476];
            }
            @Pc(41) Sound local41 = new Sound(Static13.method306(local18, 45733), false, true, local12, 0);
            if (local18 != -1) {
            ...
            if (this.aSoundPcmStream1.anInt830 != 128 || this.aSoundPcmStream1.anInt831 != 128) {
                local41.method277(this.aSoundPcmStream1.anInt830, this.aSoundPcmStream1.anInt830, -34245, this.aSoundPcmStream1.anInt831);
            }
            local41.method273(-292, this.anInt475);
            local41.method278(this.aSoundPcmStream1.anInt833 + 64, this.aSoundPcmStream1.anInt834 + 850, -30, -50, -30, true);
            return local41;
