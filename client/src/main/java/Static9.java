    ...
    public static void method231(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class47 arg1, @OriginalArg(2) Class47 arg2, @OriginalArg(3) JavaAudioChannel[] arg3) {
        try {
            if (arg0) {
                ...
                @Pc(21) int local21 = -1;
                @Pc(24) int local24 = local19.get2();
                ...
                while (true) {
                    ...
                    do {
                        ...
                        @Pc(32) int local32 = local19.get2();
                        if (local32 == 65535) {
                            local21 = local19.get2();
                            local32 = local19.get2();
                        }
                        local49 = aBasTypeArray1[local32] = new BasType();
                        local49.anInt837 = local32;
                        local49.anInt433 = local21;
                        local49.anInt838 = local19.get1();
                        local49.crawlCwSeqId = local19.get1();
                        local49.anInt436 = local19.get2();
                        local49.walkFollowCwSeqId = local19.get2();
                        local49.anInt841 = local19.get2();
                        local49.aByte10 = (byte) local19.get1();
                        local49.anInt848 = local19.get1();
                        if (local49.anInt848 == 0) {
                            local49.anInt848 = -1;
                        } else {
                            local49.anInt848 = (local49.anInt848 - 1 << 8) + local19.get1();
                        }
                        @Pc(106) int local106 = local19.get1();
                        @Pc(118) int local118;
                        if (local106 > 0) {
                            local49.anIntArray96 = new int[local106];
                            local49.anIntArray97 = new int[local106];
                            for (local118 = 0; local118 < local106; local118++) {
                                local49.anIntArray96[local118] = local19.get1();
                                local49.anIntArray97[local118] = local19.get2();
                            }
                        }
                        local118 = local19.get1();
                        @Pc(147) int local147;
                        @Pc(152) int local152;
                        if (local118 > 0) {
                            local49.anIntArrayArray7 = new int[local118][];
                            for (local147 = 0; local147 < local118; local147++) {
                                local152 = local19.get2();
                                local49.anIntArrayArray7[local147] = new int[local152];
                                for (@Pc(160) int local160 = 0; local160 < local152; local160++) {
                                    local49.anIntArrayArray7[local147][local160] = local19.get2();
                                }
                            }
                        }
                        if (local49.anInt838 == 0) {
                            local49.anInt442 = local19.get2();
                            local49.aBoolean92 = local19.get1() == 1;
                            local147 = local19.get2();
                            ...
                            for (local152 = 0; local152 < local147; local152++) {
                                local49.anIntArray98[local152] = local19.get2();
                                local49.anIntArray99[local152] = local19.get2Signed();
                                local49.anIntArray100[local152] = local19.get2Signed();
                            }
                        }
                        if (local49.anInt838 == 1) {
                            local49.walkFollowCcwSeqId = local19.get2();
                            local49.aBoolean93 = local19.get1() == 1;
                        }
                        if (local49.anInt838 == 2) {
                            ...
                            local49.aBoolean94 = local19.get1() == 1;
                            local49.aBoolean95 = local19.get1() == 1;
                            local49.aBoolean96 = local19.get1() == 1;
                            local49.aBoolean97 = local19.get1() == 1;
                            local49.anInt445 = local19.get1();
                            local49.readySeqId = local19.get1();
                            ...
                            for (local147 = 0; local147 < 20; local147++) {
                                local152 = local19.get1();
                                if (local152 == 1) {
                                    local49.anIntArray101[local147] = local19.get2Signed();
                                    local49.anIntArray102[local147] = local19.get2Signed();
                                    @Pc(353) String local353 = local19.getString();
                            ...
                            for (local152 = 0; local152 < 5; local152++) {
                                local49.aStringArray7[local152] = local19.getString();
                        ...
                        if (local49.anInt838 == 3) {
                            local49.aBoolean98 = local19.get1() == 1;
                        }
                        if (local49.anInt838 == 4 || local49.anInt838 == 1) {
                            local49.aBoolean99 = local19.get1() == 1;
                            local147 = local19.get1();
                            if (arg3 != null) {
                                local49.aJavaAudioChannel5 = arg3[local147];
                            }
                            local49.aBoolean100 = local19.get1() == 1;
                        }
                        if (local49.anInt838 == 4) {
                            local49.aString18 = local19.getString();
                            local49.aString19 = local19.getString();
                        }
                        if (local49.anInt838 == 1 || local49.anInt838 == 3 || local49.anInt838 == 4) {
                            local49.anInt447 = local19.get4();
                        }
                        if (local49.anInt838 == 3 || local49.anInt838 == 4) {
                            local49.anInt448 = local19.get4();
                            local49.anInt449 = local19.get4();
                            local49.anInt450 = local19.get4();
                        }
                        if (local49.anInt838 == 5) {
                            @Pc(516) String local516 = local19.getString();
                        ...
                        if (local49.anInt838 == 6) {
                            local32 = local19.get1();
                            if (local32 != 0) {
                                local49.anInt451 = 1;
                                local49.anInt452 = (local32 - 1 << 8) + local19.get1();
                            }
                            local32 = local19.get1();
                            if (local32 != 0) {
                                local49.anInt453 = 1;
                                local49.anInt454 = (local32 - 1 << 8) + local19.get1();
                            }
                            local32 = local19.get1();
                            if (local32 == 0) {
                                local49.anInt455 = -1;
                            } else {
                                local49.anInt455 = (local32 - 1 << 8) + local19.get1();
                            }
                            local32 = local19.get1();
                            if (local32 == 0) {
                                local49.anInt456 = -1;
                            } else {
                                local49.anInt456 = (local32 - 1 << 8) + local19.get1();
                            }
                            local49.anInt457 = local19.get2();
                            local49.anInt458 = local19.get2();
                            local49.anInt459 = local19.get2();
                        }
                        if (local49.anInt838 == 7) {
                            ...
                            local49.aBoolean100 = local19.get1() == 1;
                            local49.anInt447 = local19.get4();
                            local49.anInt445 = local19.get2Signed();
                            local49.readySeqId = local19.get2Signed();
                            local49.aBoolean95 = local19.get1() == 1;
                            local49.aStringArray7 = new String[5];
                            for (local152 = 0; local152 < 5; local152++) {
                                local49.aStringArray7[local152] = local19.getString();
                        ...
                        if (local49.crawlCwSeqId == 2 || local49.anInt838 == 2) {
                            local49.aString20 = local19.getString();
                            local49.aString21 = local19.getString();
                            local49.anInt460 = local19.get2();
                        }
                    } while (local49.crawlCwSeqId != 1 && local49.crawlCwSeqId != 4 && local49.crawlCwSeqId != 5 && local49.crawlCwSeqId != 6);
                    local49.aString22 = local19.getString();
