...
public final class Static38 {
	...
	private static Class1_Sub1_Sub3 aClass1_Sub1_Sub3_8 = new Class1_Sub1_Sub3(new byte[100], -26728);
	...
	public static String method683(@OriginalArg(0) int arg0, @OriginalArg(1) Class1_Sub1_Sub3 arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(3) int local3 = 0;
			@Pc(5) int local5 = -1;
			@Pc(18) int local18;
	...
	public static void method684(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
		try {
			if (arg1.length() > 80) {
	...
	public static String method685(@OriginalArg(0) int arg0, @OriginalArg(1) String arg1) {
		try {
			...
			method684(aClass1_Sub1_Sub3_8, arg1, false);
			@Pc(11) int local11 = aClass1_Sub1_Sub3_8.anInt742;
			while (arg0 >= 0) {
				for (@Pc(15) int local15 = 1; local15 > 0; local15++) {
				}
			}
			aClass1_Sub1_Sub3_8.anInt742 = 0;
			return method683(local11, aClass1_Sub1_Sub3_8, 9);
