...
public final class ProjAnimNode extends Class1_Sub1_Sub1 {
    ...
    public ProjAnimNode(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
        try {
            this.anInt155 = arg8;
            this.anInt156 = arg2;
            this.anInt157 = arg7;
            ...
            @Pc(83) GlShader local83 = Static12.method288(this.anInt155);
    ...
    protected Sound method676(@OriginalArg(0) int arg0) {
        try {
            ...
            @Pc(122) Sound local122 = local96.method294(this.anInt156, this.anInt157, this.anInt158, this.anInt159, this.anInt160, this.anInt161, local3);
            if (arg0 >= 0) {
                throw new NullPointerException();
            }
            return local122;
    ...
    private GlShader method50(@OriginalArg(0) byte arg0) {
        try {
            @Pc(1) int local1 = -1;
            if (arg0 != this.aByte4) {
            ...
            if (this.anInt164 != -1) {
                @Pc(22) PathingEntity local22 = Static27.aPathingEntityArray1[this.anInt164];
