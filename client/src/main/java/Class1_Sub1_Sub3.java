...
public final class Class1_Sub1_Sub3 extends Class1_Sub1 {
	...
	public Class1_Sub1_Sub3(@OriginalArg(0) boolean arg0) {
		try {
			if (!arg0) {
	...
	public void method495(@OriginalArg(0) int arg0, @OriginalArg(1) BigInteger exponent, @OriginalArg(2) BigInteger modulus) {
		try {
			@Pc(2) int local2 = this.anInt742;
			this.anInt742 = 0;
