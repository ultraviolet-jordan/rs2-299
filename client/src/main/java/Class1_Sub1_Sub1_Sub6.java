...
public final class Class1_Sub1_Sub1_Sub6 extends Class1_Sub1_Sub1 {
	...
	public Class1_Sub1_Sub1_Sub6(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		try {
			this.aClass33_2 = Static26.aClass33Array1[arg3];
			this.anInt534 = arg2;
			this.anInt535 = arg6;
			this.anInt536 = arg0;
			this.anInt537 = arg5;
		...
		try {
			...
			if (!arg1) {
				while (true) {
					do {
						do {
							if (this.anInt539 <= this.aClass33_2.aClass27_2.method506(-574, this.anInt538)) {
								return;
							}
							this.anInt539 -= this.aClass33_2.aClass27_2.method506(-574, this.anInt538) + 1;
							this.anInt538++;
	...
	protected Class1_Sub1_Sub1_Sub5 method676(@OriginalArg(0) int arg0) {
		try {
			...
			@Pc(35) Class1_Sub1_Sub1_Sub5 local35 = new Class1_Sub1_Sub1_Sub5(Static13.method306(local15, 45733), false, true, local3, 0);
			if (!this.aBoolean132) {
			...
			if (this.aClass33_2.anInt830 != 128 || this.aClass33_2.anInt831 != 128) {
				local35.method277(this.aClass33_2.anInt830, this.aClass33_2.anInt830, -34245, this.aClass33_2.anInt831);
			}
