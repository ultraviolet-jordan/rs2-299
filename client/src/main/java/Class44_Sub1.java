...
public final class Class44_Sub1 extends Class44 implements Runnable {
	...
	public void method645(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		synchronized (this.aClass32_2) {
			...
			for (local34 = (Class1_Sub1_Sub4) this.aClass32_2.method518(); local34 != null; local34 = (Class1_Sub1_Sub4) this.aClass32_2.method519(0)) {
	...
	public void method648(@OriginalArg(0) byte arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			if (this.aClient5.aClass45Array1[0] != null && this.anIntArrayArray24[arg2][arg1] != 0) {
				@Pc(25) byte[] local25 = this.aClient5.aClass45Array1[arg2 + 1].method658(arg1, 8);
				if (arg3 < 8 || arg3 > 8) {
	...
	public void method650(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			if (this.aClient5.aClass45Array1[0] != null && (this.anIntArrayArray24[arg0][arg2] != 0 && (this.aByteArrayArray5[arg0][arg2] != 0 && this.anInt945 != 0))) {
				@Pc(41) Class1_Sub1_Sub4 local41 = new Class1_Sub1_Sub4();
				local41.anInt770 = arg0;
				local41.anInt771 = arg2;
	...
	public void run() {
		try {
			while (this.aBoolean228) {
				...
				if (this.anInt945 == 0 && this.aClient5.aClass45Array1[0] != null) {
					local11 = 50;
				}
				try {
				...
				for (@Pc(32) int local32 = 0; local32 < 100 && this.aBoolean229; local32++) {
					...
					if (this.anInputStream2 != null) {
						this.method654(this.anInt944);
					}
				}
				@Pc(68) boolean local68 = false;
				@Pc(73) Class1_Sub1_Sub4 local73;
				for (local73 = (Class1_Sub1_Sub4) this.aClass29_10.method511(); local73 != null; local73 = (Class1_Sub1_Sub4) this.aClass29_10.method513(0)) {
				...
				if (this.aClient5.aBoolean54 && this.aSocket3 != null && this.anOutputStream2 != null && (this.anInt945 > 0 || this.aClient5.aClass45Array1[0] == null)) {
					this.anInt954++;
		...
		try {
			...
			while (local25 != null) {
				...
				if (this.aClient5.aClass45Array1[0] != null) {
					local36 = this.aClient5.aClass45Array1[local25.anInt770 + 1].method658(local25.anInt771, 8);
				}
				if (!this.method655(local36, (byte) 50, this.anIntArrayArray25[local25.anInt770][local25.anInt771], this.anIntArrayArray24[local25.anInt770][local25.anInt771])) {
					local36 = null;
				}
	...
	private void method652(@OriginalArg(0) int arg0) {
		try {
			...
			while (local12 != null) {
				...
				local12 = (Class1_Sub1_Sub4) this.aClass29_10.method513(0);
			}
	...
	private void method653(@OriginalArg(0) int arg0) {
		try {
			...
			while (this.anInt946 == 0) {
				if (this.anInt947 >= 10 || this.anInt945 == 0) {
					return;
				}
				...
				for (@Pc(119) int local119 = 0; local119 < 4; local119++) {
					...
					for (@Pc(131) int local131 = 0; local131 < local129; local131++) {
						if (local126[local131] == this.anInt945) {
							local126[local131] = 0;
			...
			if (arg0 == 0) {
				try {
					...
					if (this.anInt952 == 0 && local8 >= 6) {
						...
						for (@Pc(90) Class1_Sub1_Sub4 local90 = (Class1_Sub1_Sub4) this.aClass29_10.method511(); local90 != null; local90 = (Class1_Sub1_Sub4) this.aClass29_10.method513(0)) {
					...
					if (this.anInt952 > 0 && local8 >= this.anInt952) {
						...
						if (this.anInt952 + this.anInt951 >= local227.length && this.aClass1_Sub1_Sub4_1 != null) {
							if (this.aClient5.aClass45Array1[0] != null) {
								this.aClient5.aClass45Array1[this.aClass1_Sub1_Sub4_1.anInt770 + 1].method659(7, local227, this.aClass1_Sub1_Sub4_1.anInt771, local227.length);
							}
	...
	private void method656(@OriginalArg(0) Class1_Sub1_Sub4 arg0, @OriginalArg(1) byte arg1) {
		try {
