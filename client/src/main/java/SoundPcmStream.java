...
public final class SoundPcmStream {
    ...
    public Sound method523() {
        @Pc(6) Sound local6 = (Sound) Static26.aGlModel9.method591((long) this.anInt827);
        if (local6 != null) {
            return local6;
        }
        ...
        Static26.aGlModel9.method592((long) this.anInt827, local6, 10514);
        return local6;
    }
}
