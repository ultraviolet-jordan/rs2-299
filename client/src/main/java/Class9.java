...
public final class Class9 {
	...
	public void method290(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(1) int arg1) {
		try {
			@Pc(3) int local3 = -1;
			if (arg1 < 8 || arg1 > 8) {
	...
	public void method293(@OriginalArg(0) int arg0, @OriginalArg(1) Class44_Sub1 arg1) {
		try {
			if (this.anIntArray156 != null) {
	...
	public Class1_Sub1_Sub1_Sub5 method294(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(6) Class1_Sub1_Sub1_Sub5 local6 = this.method295(arg6, arg0, true, arg1);
		if (local6 == null) {
			return null;
		}
		if (this.aBoolean121 || this.aBoolean122) {
			local6 = new Class1_Sub1_Sub1_Sub5(this.aBoolean121, local6, (byte) 80, this.aBoolean122);
		}
		if (this.aBoolean121) {
			...
			local6.method266(this.anInt509);
		}
		return local6;
	}

	@OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIZI)Lclient!eb;")
	private Class1_Sub1_Sub1_Sub5 method295(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) int arg3) {
		try {
			...
			if (this.anIntArray157 == null) {
				...
				@Pc(31) Class1_Sub1_Sub1_Sub5 local31 = (Class1_Sub1_Sub1_Sub5) Static12.aClass40_5.method591(local26);
				if (local31 != null) {
					return local31;
				}
				if (this.anIntArray156 == null) {
				...
				for (local56 = 0; local56 < local54; local56++) {
					...
					local3 = (Class1_Sub1_Sub1_Sub5) Static12.aClass40_4.method591((long) local62);
					if (local3 == null) {
						...
						Static12.aClass40_4.method592((long) local62, local3, 10514);
					}
					if (local54 > 1) {
						Static12.aClass1_Sub1_Sub1_Sub5Array1[local56] = local3;
					}
				}
				if (local54 > 1) {
					local3 = new Class1_Sub1_Sub1_Sub5(local54, -314, Static12.aClass1_Sub1_Sub1_Sub5Array1);
				}
			} else {
				...
				local170 = (Class1_Sub1_Sub1_Sub5) Static12.aClass40_5.method591(local26);
				if (local170 != null) {
					return local170;
				}
				...
				local3 = (Class1_Sub1_Sub1_Sub5) Static12.aClass40_4.method591((long) local56);
				if (local3 == null) {
					...
					Static12.aClass40_4.method592((long) local56, local3, 10514);
				}
			}
			...
			local170 = new Class1_Sub1_Sub1_Sub5(Static13.method306(arg0, 45733), arg3 == 0 && arg0 == -1 && !local238 && !local50, this.anIntArray158 == null, local3, 0);
			if (arg0 != -1) {
			...
			Static12.aClass40_5.method592(local26, local170, 10514);
			return local170;
	...
	public Class9 method296(@OriginalArg(0) byte arg0) {
		try {
			@Pc(1) int local1 = -1;
			...
			if (this.anInt527 != -1) {
				@Pc(20) Class36 local20 = Static27.aClass36Array1[this.anInt527];
