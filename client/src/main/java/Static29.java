...
public final class Static29 {
    ...
    private static GlCleanerProgram aGlCleanerProgram1 = new GlCleanerProgram();
    ...
    public static int method581(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) byte[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
        @Pc(3) GlCleanerProgram local3 = aGlCleanerProgram1;
        synchronized (aGlCleanerProgram1) {
            aGlCleanerProgram1.aByteArray11 = arg2;
            aGlCleanerProgram1.anInt911 = arg4;
            aGlCleanerProgram1.aByteArray12 = arg0;
            aGlCleanerProgram1.id = 0;
            aGlCleanerProgram1.anInt912 = arg3;
            aGlCleanerProgram1.anInt916 = arg1;
            aGlCleanerProgram1.anInt921 = 0;
            aGlCleanerProgram1.anInt920 = 0;
            aGlCleanerProgram1.anInt913 = 0;
            aGlCleanerProgram1.anInt914 = 0;
            aGlCleanerProgram1.anInt917 = 0;
            aGlCleanerProgram1.anInt918 = 0;
            aGlCleanerProgram1.anInt923 = 0;
            method583(aGlCleanerProgram1);
            return arg1 - aGlCleanerProgram1.anInt916;
        }
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lclient!sb;)V")
    private static void method582(@OriginalArg(0) GlCleanerProgram arg0) {
    ...
    private static void method583(@OriginalArg(0) GlCleanerProgram arg0) {
        ...
        while (true) {
            while (local60) {
                ...
                for (local340 = 0; local340 < local248; local340++) {
                    ...
                    for (local164 = 0; local164 < local244; local164++) {
                        while (true) {
                            local64 = method585(arg0);
                            if (local64 == 0) {
                                arg0.aByteArrayArray5[local340][local164] = (byte) local346;
                                break;
                            }
                            local64 = method585(arg0);
                            if (local64 == 0) {
                ...
                for (local340 = 0; local340 < local248; local340++) {
                    ...
                    for (local164 = 0; local164 < local244; local164++) {
                        if (arg0.aByteArrayArray5[local340][local164] > local390) {
                            local390 = arg0.aByteArrayArray5[local340][local164];
                        }
                        if (arg0.aByteArrayArray5[local340][local164] < local388) {
                            local388 = arg0.aByteArrayArray5[local340][local164];
                        }
                    }
                    method588(arg0.anIntArrayArray21[local340], arg0.anIntArrayArray22[local340], arg0.anIntArrayArray23[local340], arg0.aByteArrayArray5[local340], local388, local390, local244);
    ...
    private static byte method584(@OriginalArg(0) GlCleanerProgram arg0) {
        return (byte) method586(8, arg0);
    }

    @OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
    private static byte method585(@OriginalArg(0) GlCleanerProgram arg0) {
        return (byte) method586(1, arg0);
    }

    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
    private static int method586(@OriginalArg(0) int arg0, @OriginalArg(1) GlCleanerProgram arg1) {
    ...
    private static void method587(@OriginalArg(0) GlCleanerProgram arg0) {
        arg0.anInt928 = 0;
