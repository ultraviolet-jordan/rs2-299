		...
		try {
			...
			for (@Pc(13) int local13 = 0; local13 < 50; local13++) {
				try {
					...
					if (aBoolean146 && aClass1_Sub1_Sub2_Sub3Array5[local13].anInt679 == 128) {
						aClass1_Sub1_Sub2_Sub3Array5[local13].method413(34694);
					} else {
						aClass1_Sub1_Sub2_Sub3Array5[local13].method414(anInt593);
					}
					anInt597++;
			...
			if (arg0 > 0) {
				...
				for (@Pc(305) int local305 = 0; local305 < 50; local305++) {
					if (aClass1_Sub1_Sub2_Sub3Array5[local305] != null) {
						@Pc(316) int[] local316 = aClass1_Sub1_Sub2_Sub3Array5[local305].anIntArray212;
