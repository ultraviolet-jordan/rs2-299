...
public final class Sound extends Class1_Sub1_Sub1 {
    ...
    public GlIndexedSprite[] aGlIndexedSpriteArray8;
    ...
    public Sound(@OriginalArg(0) boolean arg0) {
        try {
            if (arg0) {
                // Static11.aBoolean112 = true; Dead code from deob.
            }
    ...
    public Sound(@OriginalArg(0) int arg0, @OriginalArg(1) byte arg1) {
        try {
            Static11.anInt489++;
            @Pc(26) ClanMember local26 = Static11.aClanMemberArray1[arg0];
    ...
    public Sound(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) Sound[] arg2) {
        try {
            Static11.anInt489++;
            ...
            for (@Pc(54) int local54 = 0; local54 < arg0; local54++) {
                @Pc(60) Sound local60 = arg2[local54];
                if (local60 != null) {
            ...
            for (@Pc(232) int local232 = 0; local232 < arg0; local232++) {
                @Pc(238) Sound local238 = arg2[local232];
                if (local238 != null) {
                    @Pc(262) int local262;
    ...
    public Sound(@OriginalArg(0) int arg0, @OriginalArg(1) Sound[] arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3) {
        try {
            Static11.anInt489++;
            @Pc(24) boolean local24 = false;
            @Pc(26) boolean local26 = false;
            ...
            for (@Pc(44) int local44 = 0; local44 < arg0; local44++) {
                @Pc(50) Sound local50 = arg1[local44];
                if (local50 != null) {
            ...
            for (@Pc(234) int local234 = 0; local234 < arg0; local234++) {
                @Pc(240) Sound local240 = arg1[local234];
                if (local240 != null) {
    ...
    public Sound(@OriginalArg(0) boolean arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2, @OriginalArg(3) Sound arg3, @OriginalArg(4) int arg4) {
        try {
            Static11.anInt489++;
    ...
    public Sound(@OriginalArg(0) boolean arg0, @OriginalArg(1) Sound arg1, @OriginalArg(2) byte arg2, @OriginalArg(3) boolean arg3) {
        try {
            Static11.anInt489++;
            ...
            if (arg3) {
                ...
                super.aGlIndexedSpriteArray10 = new GlIndexedSprite[this.anInt490];
                for (local123 = 0; local123 < this.anInt490; local123++) {
                    @Pc(171) GlIndexedSprite local171 = super.aGlIndexedSpriteArray10[local123] = new GlIndexedSprite();
                    @Pc(176) GlIndexedSprite local176 = arg1.aGlIndexedSpriteArray10[local123];
                ...
                this.aGlIndexedSpriteArray8 = arg1.aGlIndexedSpriteArray8;
            } else {
    ...
    public void method263(@OriginalArg(0) Sound arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) boolean arg2) {
        try {
    ...
    private int method264(@OriginalArg(0) Sound arg0, @OriginalArg(1) int arg1) {
        @Pc(3) int local3 = -1;
    ...
    public void method269(@OriginalArg(0) boolean arg0, @OriginalArg(1) int arg1) {
        try {
            if (this.anIntArrayArray8 != null && arg1 != -1) {
                @Pc(11) DelayedStateChange local11 = Static13.method305(true, arg1);
                if (local11 != null) {
                    @Pc(17) Player local17 = local11.aPlayer1;
                    Static11.anInt503 = 0;
                    if (arg0) {
                        Static11.anInt504 = 0;
                        Static11.anInt505 = 0;
        ...
        try {
            if (arg2 != -1) {
                if (arg3 == null || arg1 == -1) {
                    ...
                    @Pc(19) DelayedStateChange local19 = Static13.method305(true, arg2);
                    if (local19 != null) {
                        @Pc(26) DelayedStateChange local26 = Static13.method305(true, arg1);
                        if (local26 == null) {
                            this.method269(true, arg2);
                        } else {
                            @Pc(36) Player local36 = local19.aPlayer1;
                            Static11.anInt503 = 0;
                            Static11.anInt504 = 0;
                            Static11.anInt505 = 0;
    ...
    public void method278(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) boolean arg5) {
        ...
        @Pc(50) int local50;
        if (super.aGlIndexedSpriteArray10 == null) {
            super.aGlIndexedSpriteArray10 = new GlIndexedSprite[this.anInt490];
            for (local50 = 0; local50 < this.anInt490; local50++) {
                super.aGlIndexedSpriteArray10[local50] = new GlIndexedSprite();
            }
        }
        @Pc(73) int local73;
        for (local50 = 0; local50 < this.anInt491; local50++) {
            ...
            if (this.anIntArray127 == null || (this.anIntArray127[local50] & 0x1) == 0) {
                @Pc(251) GlIndexedSprite local251 = super.aGlIndexedSpriteArray10[local73];
                local251.anInt776 += local151;
                local251.anInt777 += local159;
                local251.anInt778 += local167;
                local251.anInt779++;
                @Pc(280) GlIndexedSprite local280 = super.aGlIndexedSpriteArray10[local78];
                local280.anInt776 += local151;
                local280.anInt777 += local159;
                local280.anInt778 += local167;
                local280.anInt779++;
                @Pc(309) GlIndexedSprite local309 = super.aGlIndexedSpriteArray10[local83];
        ...
        if (arg5) {
            ...
            this.aGlIndexedSpriteArray8 = new GlIndexedSprite[this.anInt490];
            for (local73 = 0; local73 < this.anInt490; local73++) {
                @Pc(399) GlIndexedSprite local399 = super.aGlIndexedSpriteArray10[local73];
                @Pc(408) GlIndexedSprite local408 = this.aGlIndexedSpriteArray8[local73] = new GlIndexedSprite();
    ...
    public void method279(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4) {
        ...
        for (@Pc(3) int local3 = 0; local3 < this.anInt491; local3++) {
            ...
            @Pc(33) GlIndexedSprite local33;
            @Pc(55) int local55;
            @Pc(28) int local28;
            if (this.anIntArray127 == null) {
                local28 = this.anIntArray130[local3];
                local33 = super.aGlIndexedSpriteArray10[local10];
                ...
                @Pc(68) GlIndexedSprite local68 = super.aGlIndexedSpriteArray10[local15];
                ...
                @Pc(103) GlIndexedSprite local103 = super.aGlIndexedSpriteArray10[local20];
                ...
                local33 = super.aGlIndexedSpriteArray10[local15];
                local55 = arg0 + (arg2 * local33.anInt776 + arg3 * local33.anInt777 + arg4 * local33.anInt778) / (arg1 * local33.anInt779);
                this.anIntArray125[local3] = Static11.method280(local28, local55, local152);
                local33 = super.aGlIndexedSpriteArray10[local20];
                local55 = arg0 + (arg2 * local33.anInt776 + arg3 * local33.anInt777 + arg4 * local33.anInt778) / (arg1 * local33.anInt779);
                this.anIntArray126[local3] = Static11.method280(local28, local55, local152);
            }
        }
        super.aGlIndexedSpriteArray10 = null;
        this.aGlIndexedSpriteArray8 = null;
        this.anIntArray134 = null;
        this.anIntArray135 = null;
        if (this.anIntArray127 != null) {
