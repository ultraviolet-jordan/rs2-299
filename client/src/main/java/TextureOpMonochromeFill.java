...
public final class TextureOpMonochromeFill implements ImageProducer, ImageObserver {
    ...
    public TextureOpMonochromeFill(@OriginalArg(0) java.awt.Component arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
        try {
            if (arg1 == 3) {
