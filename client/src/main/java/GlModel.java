...
public final class GlModel {
    ...
    private ObjStackNode anObjStackNode35 = new ObjStackNode();

    @OriginalMember(owner = "client!s", name = "j", descriptor = "Lclient!pb;")
    private PcmSound aPcmSound1 = new PcmSound(true);
    ...
    private StockMarketOffer aStockMarketOffer1;

    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(II)V")
    public GlModel(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
        try {
            this.anInt900 = arg1;
            this.anInt901 = arg1;
            if (arg0 >= 0) {
            ...
            this.aStockMarketOffer1 = new StockMarketOffer(-143, 1024);
    ...
    public ObjStackNode method591(@OriginalArg(0) long arg0) {
        @Pc(5) ObjStackNode local5 = (ObjStackNode) this.aStockMarketOffer1.method632(arg0);
        if (local5 == null) {
            this.anInt898++;
        } else {
            this.aPcmSound1.method516(local5);
            this.anInt899++;
        }
        return local5;
    }
    ...
    public void method592(@OriginalArg(0) long arg0, @OriginalArg(1) ObjStackNode arg1, @OriginalArg(2) int arg2) {
        try {
            if (arg2 != this.anInt896) {
                this.aBoolean221 = !this.aBoolean221;
            }
            if (this.anInt901 == 0) {
                @Pc(20) ObjStackNode local20 = this.aPcmSound1.method517();
                local20.method1211();
                local20.close();
                if (local20 == this.anObjStackNode35) {
                    local20 = this.aPcmSound1.method517();
                    local20.method1211();
                    local20.close();
                }
            } else {
            ...
            this.aStockMarketOffer1.method633(arg1, 944, arg0);
            this.aPcmSound1.method516(arg1);
    ...
    public void method593() {
        while (true) {
            @Pc(3) ObjStackNode local3 = this.aPcmSound1.method517();
            if (local3 == null) {
