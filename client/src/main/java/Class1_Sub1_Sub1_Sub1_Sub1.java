...
public final class Class1_Sub1_Sub1_Sub1_Sub1 extends Class1_Sub1_Sub1_Sub1 {
    ...
    protected Sound method676(@OriginalArg(0) int arg0) {
        try {
            ...
            @Pc(10) Sound local10 = this.method40(false);
            if (local10 == null) {
                return null;
            }
            ...
            if (arg0 >= 0) {
                ...
                if (super.anInt1007 != -1 && super.anInt1008 != -1) {
                    @Pc(47) SoundPcmStream local47 = Static26.aSoundPcmStreamArray1[super.anInt1007];
                    @Pc(50) Sound local50 = local47.method523();
                    if (local50 != null) {
                        @Pc(64) Sound local64 = new Sound(Static13.method306(super.anInt1008, 45733), false, true, local50, 0);
                        ...
                        @Pc(132) Sound[] local132 = new Sound[]{local10, local64};
                        local10 = new Sound(2, local132, (byte) 80, true);
                    }
                }
                if (this.aSound1 != null) {
                    if (Static8.anInt297 >= this.anInt132) {
                        this.aSound1 = null;
                    }
                    if (Static8.anInt297 >= this.anInt131 && Static8.anInt297 < this.anInt132) {
                        @Pc(161) Sound local161 = this.aSound1;
                        ...
                        @Pc(224) Sound[] local224 = new Sound[]{local10, local161};
                        local10 = new Sound(2, local224, (byte) 80, true);
                        if (super.anInt1021 == 512) {
                            local161.method272((byte) -125);
                        } else if (super.anInt1021 == 1024) {
                            local161.method272((byte) -125);
    ...
    private Sound method40(@OriginalArg(0) boolean arg0) {
        try {
            ...
            @Pc(154) Sound local154 = (Sound) Static2.aGlModel1.method591(local48);
            @Pc(160) int local160;
            @Pc(167) int local167;
            if (local154 == null) {
                ...
                for (local160 = 0; local160 < 12; local160++) {
                    ...
                    if (local167 >= 256 && local167 < 512 && !Static22.aTextureOpRasterizerShapeArray1[local167 - 256].method498((byte) -41)) {
                        local158 = true;
                    }
                ...
                if (local158) {
                    if (this.aLong9 != -1L) {
                        local154 = (Sound) Static2.aGlModel1.method591(this.aLong9);
                    }
                    if (local154 == null) {
                        return null;
                    }
            ...
            if (local154 == null) {
                @Pc(237) Sound[] local237 = new Sound[12];
                local160 = 0;
                @Pc(248) int local248;
                for (local167 = 0; local167 < 12; local167++) {
                    ...
                    @Pc(276) Sound local276;
                    if (local248 >= 256 && local248 < 512) {
                        local276 = Static22.aTextureOpRasterizerShapeArray1[local248 - 256].method499(-514);
                        if (local276 != null) {
                ...
                local154 = new Sound(local160, -314, local237);
                ...
                Static2.aGlModel1.method592(local48, local154, 10514);
                this.aLong9 = local48;
            }
            if (this.aBoolean25) {
                return local154;
            }
            @Pc(381) Sound local381 = Static11.aSound2;
    ...
    public Sound method41(@OriginalArg(0) int arg0) {
        try {
            if (!this.aBoolean24) {
                return null;
                ...
                for (@Pc(18) int local18 = 0; local18 < 12; local18++) {
                    ...
                    if (local25 >= 256 && local25 < 512 && !Static22.aTextureOpRasterizerShapeArray1[local25 - 256].method500(875)) {
                        local16 = true;
                    }
                ...
                @Pc(128) Sound local128 = new Sound(local68, -314, local66);
