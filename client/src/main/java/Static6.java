...
public final class Static6 {
				...
				while (true) {
					...
					while (!local31) {
						...
						if (local73 > 0 && local77 > 0 && local73 < 103 && local77 < 103) {
							@Pc(90) Class9 local90 = Static12.method288(local18);
	...
	public static void method59(@OriginalArg(0) Class1_Sub1_Sub3 arg0, @OriginalArg(1) Class44_Sub1 arg1, @OriginalArg(2) byte arg2) {
		try {
			if (arg2 != -75) {
				anInt170 = 109;
			}
			...
			while (true) {
				...
				local8 += local11;
				@Pc(20) Class9 local20 = Static12.method288(local8);
	...
	public static int method69(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		if (arg0 == -1) {
			return 12345678;
		}
	...
	public static boolean method72(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			...
			@Pc(12) Class9 local12 = Static12.method288(arg0);
			if (arg2 == 11) {
				arg2 = 10;
			}
			if (arg2 >= 5 && arg2 <= 8) {
	...
	public static void method73(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int[][][] arg3, @OriginalArg(4) Class19 arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) Class37 arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
		try {
			...
			@Pc(54) Class9 local54 = Static12.method288(arg2);
				...
				if (arg10 == 22) {
					...
					if (arg10 == 10 || arg10 == 11) {
						...
						if (local54.anInt515 == -1 && local54.anIntArray160 == null) {
							...
							local104 = new Class1_Sub1_Sub1_Sub2(local41, true, arg10, 0, local9, local19, local31, arg5, arg2, local54.anInt515);
						}
