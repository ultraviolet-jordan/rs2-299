...
public class AnimFrame extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    protected TextureOpMonochromeFill aTextureOpMonochromeFill2;
    ...
    private SkyBoxCube[] aSkyBoxCubeArray2 = new SkyBoxCube[6];
    ...
    protected final void method84(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
        try {
            ...
            this.aTextureOpMonochromeFill2 = new TextureOpMonochromeFill(this.method94(1), (byte) 3, this.anInt194, this.anInt193);
