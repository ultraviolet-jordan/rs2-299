...
public final class Class1_Sub1_Sub1_Sub1_Sub2 extends Class1_Sub1_Sub1_Sub1 {
    ...
    protected Sound method676(@OriginalArg(0) int arg0) {
        try {
            ...
            @Pc(8) Sound local8 = this.method682(false);
            if (local8 == null) {
                return null;
            }
            ...
            if (super.anInt1007 != -1 && super.anInt1008 != -1) {
                @Pc(41) SoundPcmStream local41 = Static26.aSoundPcmStreamArray1[super.anInt1007];
                @Pc(44) Sound local44 = local41.method523();
                if (local44 != null) {
                    @Pc(53) int local53 = local41.aClass27_2.anIntArray225[super.anInt1008];
                    @Pc(64) Sound local64 = new Sound(Static13.method306(local53, 45733), false, true, local44, 0);
                    ...
                    @Pc(127) Sound[] local127 = new Sound[]{local8, local64};
                    local8 = new Sound(2, local127, (byte) 80, true);
                }
            }
    ...
    private Sound method682(@OriginalArg(0) boolean arg0) {
        try {
            @Pc(14) int local14;
